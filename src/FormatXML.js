...
export default class FormatXML
{
   ...
   {
      const jsonObject = TransformFormat.format(report, this._jsonFormatName, options);
   ...
   {
      const jsonObject = TransformFormat.format(result, this._jsonFormatName, options);
